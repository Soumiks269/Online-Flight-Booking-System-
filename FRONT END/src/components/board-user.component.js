...
function BoardUser() {
  ...
  const fecthdata = () => {
    axios
      .get("http://localhost:8098/api/auth/getallusers")
  ...
  return (
    <div className="adminback">
      <h2>
        <center>Sign Up Details All Users</center>
      </h2>
      <br></br>
      <br></br>
      <br></br>
      <center>
        <table className="tabledesign table-bordered table-striped" border={3}>
